...
def cot_to_algolia(cot: Cot) -> Dict:
    ...
    return {
        ...
        "num": cot.num,
    "client": cot.client,
    "empresa": getattr(cot, 'empresa', cot.client),
    "at": getattr(cot, 'nombre', ''),
    "consultora": getattr(cot, 'consultora', ''),
    "facturar": getattr(cot, 'facturar', ''),
    "mail_receptor": getattr(cot, 'email', ''),
